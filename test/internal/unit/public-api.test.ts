...
it("exposes distro-owned configuration and lifecycle contracts", () => {
  ...
  expectTypeOf<keyof MicrosoftOpenTelemetryBrowserOptions>().toEqualTypeOf<
    "spanProcessors" | "logRecordProcessors" | "instrumentationOptions"
  >();
  expectTypeOf<MicrosoftOpenTelemetryBrowserOptions["instrumentationOptions"]>().toEqualTypeOf<
    InstrumentationOptions | undefined
  >();
